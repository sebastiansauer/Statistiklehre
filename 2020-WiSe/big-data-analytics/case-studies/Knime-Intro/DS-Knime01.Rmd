...
- [First Workflow](https://www.knime.com/getting-started-guide)
...
A number of *guided practiced* (GP) and *exercises* (Ex) are provided. In the first step, the instructor presents some materials alongside with concepts and how-to (GP). This is followed by exercises (without instantaneous solutions) to be solved by the participants. 
...
- Download [this workflow](https://kni.me/w/AS9_Hi7wc3iTwgL_)
