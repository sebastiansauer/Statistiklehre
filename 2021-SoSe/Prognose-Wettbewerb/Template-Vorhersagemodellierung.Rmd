...
```{r}
train <- read_csv("https://raw.githubusercontent.com/sebastiansauer/Statistiklehre/main/data/tips/tips_train.csv")
test <- read_csv("https://raw.githubusercontent.com/sebastiansauer/Statistiklehre/main/data/tips/tips_test.csv")
```
...
```{r}
glimpse(tips_test_mit_vorhersage)
```
