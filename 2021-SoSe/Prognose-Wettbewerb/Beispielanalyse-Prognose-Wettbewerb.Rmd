...
```{r}
tips_train <- read_csv("https://raw.githubusercontent.com/sebastiansauer/Statistiklehre/main/data/tips/tips_train.csv")
tips_test <- read_csv("https://raw.githubusercontent.com/sebastiansauer/Statistiklehre/main/data/tips/tips_test.csv")
```
